    ...
    <body>
        <div id="container" class="clearfix">
            ...
            <ul id="nav">
                ...
                <li><a href="viewownerfile.jsp?<%=name%>">View File Details</a></li>
                <li><a href="viewuser1.jsp">User Details</a></li>
                <li><a href="downloadfilelist01.jsp">View/Download Files</a></li>
                <li><a href="requestcia1.jsp">Request Password to CIA</a></li>
                <li><a href="granted3.jsp">View CIA Password</a></li>
