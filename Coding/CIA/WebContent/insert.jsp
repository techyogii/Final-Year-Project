    ...
    <body>
        <%
            ...
            try {
                ...
                PreparedStatement ps = conn.prepareStatement("insert into login (name,username,emailid,password,confirmpassword,dob,address,mobileno,country,gender,utype) values (?,?,?,?,?,?,?,?,?,?,?)");
