<html>
    ...
    <body>
        <form name="form1" action="insert_user.jsp" method="post" onSubmit="return valid1()">
                ...
                <div id="content">
                    ...
                    <table  bgcolor="#00000">
                        ...
                        <tr><td><strong><font color="#FFFFFF" size="2">UserType</font></strong></td>
                            <td><font color="#FFFFFF">:</font></td>
                            <td><select name="utype"><option value="0">--Select--</option><option value="user">User</option></select></td></tr>
